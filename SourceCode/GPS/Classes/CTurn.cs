        ...
        public void BuildTurnLines()
        {
            ...
            for (int j = 0; j < bndList.Count; j++)
            {
                ...
                for (int i = ptCount - 1; i >= 0; i--)
                {
                    ...
                    bool isPointInsideBoundary = bndList[j].fenceLineEar.IsPointInPolygon(point);
                    bool isOuterBoundary = j == 0;
                    bool keepTurnPoint = totalHeadWidth >= 0
                        ? isOuterBoundary == isPointInsideBoundary
                        : isOuterBoundary != isPointInsideBoundary;
