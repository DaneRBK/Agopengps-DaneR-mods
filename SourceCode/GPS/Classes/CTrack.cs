...
namespace AgOpenGPS
{
    ...
    public class CTrk
    {
        ...
        public Dictionary<int, double> workedTrackDistances = new Dictionary<int, double>();
        ...
        public CTrk(CTrk _trk)
        {
            ...
            workedTracks = new HashSet<int>(_trk.workedTracks);
            workedTrackDistances = new Dictionary<int, double>(_trk.workedTrackDistances);
        }
    }
}
