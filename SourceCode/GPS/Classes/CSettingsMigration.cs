...
namespace AgOpenGPS
{
    public static class CSettingsMigration
    {
        ...
        private static void CopyVehicleSettings(SettingsLegacy source, VehicleSettings dest)
        {
            ...
            dest.setAS_KpLeft = source.setAS_Kp;
            dest.setAS_KpRight = source.setAS_Kp;
            dest.setAS_isKpSplit = true;
            dest.setAS_countsPerDegree = source.setAS_countsPerDegree;
            dest.setAS_minSteerPWM = source.setAS_minSteerPWM;
            dest.setAS_minSteerPWMLeft = source.setAS_minSteerPWM;
            dest.setAS_minSteerPWMRight = source.setAS_minSteerPWM;
            dest.setAS_isMinSteerPWMSplit = true;
