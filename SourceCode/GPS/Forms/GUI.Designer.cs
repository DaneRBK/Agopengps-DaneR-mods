...
namespace AgOpenGPS
{
    ...
    public partial class FormGPS
    {
        ...
        public void LoadText()
        {
            ...
            advancedSettingsMenu.Text = "Advanced settings";
            steerWizardMenuItem.Text = gStr.gsSteerWizard;
            imuRollWizardMenuItem.Text = "IMU Roll Offset Wizard\r\nManual";
            autoRollOffsetWizardMenuItem.Text = "Auto Roll Offset";
            headingOffsetWizardMenuItem.Text = "Auto Heading Offset";
            xteGuardWizardMenuItem.Text = "Xte guard";
            rollCutMenuItem.Text = "Roll cut";
            adaptiveSteeringMenuItem.Text = "Adaptive steering";
            adaptiveSteeringAiMenuItem.Text = "Adaptive steering AI";
            bodyLineHoldMenuItem.Text = "Body line hold";
            obstacleOffsetMenuItem.Text = "Obstacle offset";
        ...
        public void PanelBuildRightMenu()
        {
            ...
            panelRight.Controls.Add(btnMarkedEdgesBoundary);
        ...
        private void oglMain_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (TryHandleObstacleTouchMap(point))
                {
                    return;
                }

                if (TryStartObstacleDeleteHold(point))
                {
                    return;
                }
        ...
        private void oglMain_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                CancelObstacleDeleteHoldIfMoved(e.Location);
                TryDragPendingObstacle(e.Location);
            }
        }
