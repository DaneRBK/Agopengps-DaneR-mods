...
namespace AgOpenGPS
{
    ...
    public partial class FormGPS : Form
    {
        ...
        public FormGPS()
        {
            ...
            InitializeComponent();
            InitializeWindowsDeviceResetButton();
            ApplyTopButtonRestyle();
            ...
            if (Properties.VehicleSettings.Default.setAS_autoWasZeroEnabled)
            {
                smartWAS.Start();
            }

            StartMobileRemoteServer();
            FormClosed += (sender, args) => StopMobileRemoteServer();
        }
