...
namespace AgOpenGPS
{
    public partial class FormConfig
    {
        ...
        public void SetDualHeadingOffsetDisplay(double newOffset)
        {
            decimal displayValue = Math.Max(nudDualHeadingOffset.Minimum, Math.Min(nudDualHeadingOffset.Maximum, (decimal)newOffset));
            nudDualHeadingOffset.Value = displayValue;
        }
