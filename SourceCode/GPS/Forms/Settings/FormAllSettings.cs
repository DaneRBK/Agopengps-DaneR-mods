...
namespace AgOpenGPS
{
    public partial class FormAllSettings : Form
    {
        ...
        private static void PopulateVehicle(DataGridView left, DataGridView mid, DataGridView right, VehicleSettings vs)
        {
            ...
            AddRow(left, "Adaptive Steer", vsDefault.setAS_adaptiveSteerEnabled, vs.setAS_adaptiveSteerEnabled);
            AddRow(left, "Adaptive Calm %", vsDefault.setAS_adaptiveSteerCalmResponsePercent, vs.setAS_adaptiveSteerCalmResponsePercent);
            AddRow(left, "Adaptive Boost %", vsDefault.setAS_adaptiveSteerMaxBoostPercent, vs.setAS_adaptiveSteerMaxBoostPercent);
            AddRow(left, "Adaptive Delay", vsDefault.setAS_adaptiveSteerBoostDelaySec, vs.setAS_adaptiveSteerBoostDelaySec);
            AddRow(left, "Adaptive Samples", vsDefault.setAS_adaptiveSteerRequiredSamples, vs.setAS_adaptiveSteerRequiredSamples);
            AddRow(left, "Body Hold", vsDefault.setAS_bodyLineHoldEnabled, vs.setAS_bodyLineHoldEnabled);
            AddRow(left, "Body Hold Gain", vsDefault.setAS_bodyLineHoldGain, vs.setAS_bodyLineHoldGain);
            AddRow(left, "Body Hold Max", vsDefault.setAS_bodyLineHoldMaxCorrection, vs.setAS_bodyLineHoldMaxCorrection);
            AddRow(left, "Body Hold Filter", vsDefault.setAS_bodyLineHoldFilterPercent, vs.setAS_bodyLineHoldFilterPercent);
