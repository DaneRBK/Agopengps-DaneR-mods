...
namespace AgOpenGPS
{
    public partial class FormSteer : Form
    {
        ...
        private void FormSteer_Load(object sender, EventArgs e)
        {
            ...
            // Smart WAS background tracking is controlled from Adaptive Steering AI.
            if (Properties.VehicleSettings.Default.setAS_autoWasZeroEnabled && !mf.smartWAS.IsCollecting)
            {
                mf.smartWAS.Start();
            }
        }
        ...
        private void FormSteer_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            SaveStandardCountsPerDegreeToSettingsAndPgn();
            ...
            SaveStandardSteerGainToSettingsAndPgn();
        ...
        private void SaveStandardSteerGainToSettingsAndPgn()
        {
            byte kp = unchecked((byte)hsbarProportionalGain.Value);
            byte min = unchecked((byte)hsbarMinPWM.Value);

            Properties.VehicleSettings.Default.SetStandardSteerGain(kp, min);
            mf.p_252.pgn[mf.p_252.gainProportional] = kp;
            mf.p_252.pgn[mf.p_252.minPWM] = min;
        }
        ...
        private void SaveStandardCountsPerDegreeToSettingsAndPgn()
        {
            byte counts = unchecked((byte)hsbarCountsPerDegree.Value);

            Properties.VehicleSettings.Default.setAS_countsPerDegree = counts;
            mf.p_252.pgn[mf.p_252.countsPerDegree] = counts;
        }
        ...
        private void btnVehicleReset_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                Properties.VehicleSettings.Default.SetStandardSteerGain(50, 25);
