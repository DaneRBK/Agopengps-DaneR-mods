...
namespace AgOpenGPS
{
    public partial class FormSteerWiz : Form
    {
        ...
        private void FormSteer_Load(object sender, EventArgs e)
        {
            ...
            //min pwm, kP
            Properties.VehicleSettings.Default.NormalizeSplitSteerGain();
        ...
        private void FormSteer_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            SaveSingleCountsPerDegreeToSettingsAndPgn();
            ...
            SaveSingleSteerGainToSettingsAndPgn();
        ...
        private void btnLoadDefaults_Click(object sender, EventArgs e)
        {
            ...
            Properties.VehicleSettings.Default.SetStandardSteerGain(120, 25);
        ...
        private void SaveSingleSteerGainToSettingsAndPgn()
        {
        ...
        private void SaveSingleCountsPerDegreeToSettingsAndPgn()
        {
